...
- [ai-sec](https://github.com/hacksurvivor/ai-sec): keyless-by-default LLM security gateway and operator CLI for agent tool safety.
- [i18n-localizer](https://github.com/hacksurvivor/i18n-localizer): AI-powered localization skill for multi-framework apps.
